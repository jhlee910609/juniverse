    ...
    <div className="prose prose-invert prose-lg max-w-none">
      <ReactMarkdown
        ...
        components={{
          ...
          h2: ({ children }) => (
            <h2 className="text-3xl font-semibold mb-4 mt-8 text-white">{children}</h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-2xl font-medium mb-3 mt-6 text-white">{children}</h3>
          ),
          h4: ({ children }) => (
            <h4 className="text-xl font-medium mb-2 mt-4 text-white">{children}</h4>
          ),
          ...
          td: ({ children }) => (
            <td className="px-4 py-2 text-gray-300 border-b border-gray-700">{children}</td>
          ),
          img: ({ src, alt }) => (
