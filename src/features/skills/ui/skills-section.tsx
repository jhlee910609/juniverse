      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            다양한 프로젝트 경험을 통해 습득한 기술 스택과 전문 분야입니다. 지속적인 학습과 실무
            적용을 통해 발전시켜 나가고 있습니다.
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-2xl font-semibold text-white mb-4 text-center">핵심 성과</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-400 mb-2">50%</div>
              <p className="text-gray-300">번들 사이즈 감소</p>
              <p className="text-sm text-gray-400 mt-1">웹팩 최적화를 통한 성능 향상</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-400 mb-2">3</div>
              <p className="text-gray-300">주요 기업 프로젝트</p>
              <p className="text-sm text-gray-400 mt-1">대규모 서비스 개발 경험</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-400 mb-2">5+</div>
              <p className="text-gray-300">년 개발 경험</p>
              <p className="text-sm text-gray-400 mt-1">프론트엔드부터 풀스택까지</p>
            </div>
          </div>
        </motion.div>
      </div>
