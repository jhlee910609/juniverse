...
import { ArrowLeft, Award, Calendar, ExternalLink, MapPin, Users } from "lucide-react";
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-6 mb-6">
              ...
              {experience.teamSize && (
                ...
                >
                  <Users className="w-4 h-4" />팀 규모: {experience.teamSize}
                </div>
              )}
              {experience.website && (
                <a
          ...
          <div className="space-y-6">
            {experience.projects.map((project, index) => (
              <div
                ...
                onClick={() =>
                  router.push(
                    `/experience/${params.id}/project/${project.name
                      .toLowerCase()
                      .replace(/\s+/g, "-")
                      .replace(/[^\w-]/g, "")}`
                  )
